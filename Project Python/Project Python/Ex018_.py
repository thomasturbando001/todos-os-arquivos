...
if forma == 1:  # 10% de desconto à vista no dinheiro
    print("Você selecionou à vista no dinheiro.")
    desconto = valor * 0.10
    print("Valor à vista no dinheiro: R${:.2f}.".format(valor - desconto))

elif forma == 2:  # 5% de desconto à vista no cartão
    print("Você selecionou à vista no cartão.")
    desconto = valor * 0.05
    print("Valor à vista no cartão: R${:.2f}.".format(valor - desconto))

elif forma == 3:  # Preço normal em 2x no cartão
    print("Você selecionou em 2x no cartão.")
    print("Pagamento em 2x de R${:.2f}.".format(valor / 2))

elif forma == 4:  # 20% de juros em 3x ou mais no cartão
    ...
    if parcelas < 3:
        ...
        print("Pagamento, com juros de 20%, em {}x de R$ {:.2f}.".format(parcelas, valor_com_juros / parcelas))
